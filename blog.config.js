...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '双鱼男♓', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的虚拟币参与者🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-wheat-phi.vercel.app/, // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'BTC交易, 交易博客,BTC合约,BTC技术指标', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个虚拟币参与者, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客🎉',
